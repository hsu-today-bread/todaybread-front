...
class _StoreApi implements StoreApi {
  ...
  Future<StoreStatusResponse> getStatus() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<StoreStatusResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<StoreInfoResponse> getStoreInfo() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<StoreInfoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<NearbyStoreResponse>> getNearbyStores(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<NearbyStoreResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            NearbyStoreResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<List<FavouriteStoreResponse>> getFavouriteStores() async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<FavouriteStoreResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<FavouriteStoreToggleResponse> toggleFavouriteStore(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<FavouriteStoreToggleResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<StoreCommonResponse> updateStore(Map<String, dynamic> request) async {
    ...
    _data.addAll(request);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<StoreCommonResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<StoreImageResponse>> updateImages(List<File> images) async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<StoreImageResponse>>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
      contentType: 'multipart/form-data',
    ...
    var value = _result.data!
        .map((dynamic i) =>
            StoreImageResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
